...
namespace Empvaibhav\Component\Employee\Site\Service;
...
class Router extends RouterView
{
	...
	public function __construct(SiteApplication $app, AbstractMenu $menu, CategoryFactoryInterface $categoryFactory, DatabaseInterface $db)
	{
		...
		$this->categoryFactory = $categoryFactory;
			...
			$employeeform = new RouterViewConfiguration('employeeform');
			$employeeform->setKey('id');
			$this->registerView($employeeform);
		...
		public function getEmployeeSegment($id, $query)
		{
			...
			/**
			 * Method to get the segment(s) for an employeeform
			 *
			 * @param   string  $id     ID of the employeeform to retrieve the segments for
			 * @param   array   $query  The request that is built right now
			 *
			 * @return  array|string  The segments of this item
			 */
			public function getEmployeeformSegment($id, $query)
			{
				return $this->getEmployeeSegment($id, $query);
			}
		...
		public function getEmployeeId($segment, $query)
		{
			 ...
			 * Method to get the segment(s) for an employeeform
			 *
			 * @param   string  $segment  Segment of the employeeform to retrieve the ID for
			 * @param   array   $query    The request that is parsed right now
			 *
			 * @return  mixed   The id of this item or false
			 */
			public function getEmployeeformId($segment, $query)
			{
				return $this->getEmployeeId($segment, $query);
			}
