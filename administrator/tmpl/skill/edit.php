...
<form
	action="<?php echo Route::_('index.php?option=com_employee&layout=edit&id=' . (int) $this->item->id); ?>"
	...
	<?php echo HTMLHelper::_('uitab.addTab', 'myTab', 'employee', Text::_('Skills', true)); ?>
	<div class="row-fluid">
		<div class="col-md-12 form-horizontal">
			<fieldset class="adminform">
				<legend><?php echo Text::_('Skills'); ?></legend>
