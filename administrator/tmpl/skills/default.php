				...
				<table class="table table-striped" id="employeeList">
					...
					<?php foreach ($this->items as $i => $item) :
						...
						<tr class="row<?php echo $i % 2; ?>" data-draggable-group='1' data-transition>
							...
							<td class="text-center">
								<?php echo HTMLHelper::_('jgrid.published', $item->state, $i, 'skill.', $canChange, 'cb'); ?>
							</td>
							...
							<td>
								...
								<?php endif; ?>
								<?php if ($canEdit) : ?>
									<a href="<?php echo Route::_('index.php?option=com_employee&task=skill.edit&id='.(int) $item->id); ?>">
