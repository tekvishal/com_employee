...
namespace Empvaibhav\Component\Employee\Administrator\Model;
// No direct access.
...
class DepartmentModel extends AdminModel
{
	 ...
	 * @since  1.0.0
	 */
	protected $text_prefix = 'COM_EMPLOYEE';
	 ...
	 * @since  1.0.0
	 */
	public $typeAlias = 'com_employee.department';
	 ...
	 * @since   1.0.0
	 */
	public function getTable($type = 'Departments', $prefix = 'Administrator', $config = array())
	{
	...
	protected function loadFormData()
	{
		...
		$data = Factory::getApplication()->getUserState('com_employee.edit.skill.data', array());
	...
	/**
	 * Method to duplicate an Employee
	 *
	...
	public function duplicate(&$pks)
	{
		...
		// Access checks.
		if (!$user->authorise('core.create', 'com_employee'))
		{
	...
	protected function prepareTable($table)
	{
		...
		if (empty($table->id))
		{
			...
			{
				$db = $this->getDbo();
				$db->setQuery('SELECT MAX(ordering) FROM #__skills');
				$max             = $db->loadResult();
